...
export default function QuitTherapy({ ...props }) {
  const classes = useStyles()
  const [result, setResult] = React.useState(props.report && !!props.report.quitTheray ? props.report.quitTheray : null)
  ...
  const onUpdateReport = () => {
    ...
    if (updateReport) {
      updateReport('quitTheray', result)
    }

...
class PopTheBubbles extends React.Component<{}, AppState> {
  ...
  constructor(props: {}) {
    ...
    this.bubbleCount =
      typeof process.env.REACT_APP_POP_LEVEL1_BUBBLE_COUNT === "undefined"
        ? 60
  ...
  onCompleted = (
    ...
    if (this.state.gameLevel === 3) {
      ...
      this.bubbleCount =
        typeof process.env.REACT_APP_POP_LEVEL2_3_BUBBLE_COUNT === "undefined"
          ? 80
  ...
  getLevelCases = () => {
    ...
    switch (this.state.level) {
      ...
      case 1:
        const alertTextTop =
          this.state.gameLevel === 1 ? alerts.LEVEL1_TOP : alerts.LEVEL2_3_TOP;
        const alertTextBottom =
          this.state.gameLevel === 1
            ? alerts.LEVEL1_BOTTOM
            : this.state.gameLevel === 2
            ? alerts.LEVEL2_BOTTOM
            : alerts.LEVEL3_BOTTOM;

        infoSection = (
          <div className="pop-the-bubble-board">
            <div className="mt-30">
              <h1>Level {this.state.gameLevel}</h1>
              <div className="pl-30 pr-30 game-rule text-center">
                <div className="pl-30 pr-30 game-rule text-center">
                  <p>{alertTextTop}</p>
                  <br />

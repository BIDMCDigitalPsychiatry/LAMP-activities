            ...
            <div className={classes.container}>
              {timeLeft !== 0 && (
                <div className={classes.timer}>
                  ...
                  <h4>
                    {t("Time left:")} {timeLeft} {t("seconds")}
                  </h4>
                  {!!textShow && !!startGame && (
                    <span className={classes.boxAlert}>{`${t(
                      "Observe the symbol shown and press the number corresponding to it."
                    )}`}</span>
                  )}
                </div>
              )}
              <div className={classes.main}>
                {timeLeft !== 0 ? (
                    ...
                    <div className={classes.startDiv}>
                      {!startGame && showMapping === "before" && (
                        <span>
                          <p>
                            <b>
                              In this game mode, try to memorize the key. Once
                              you press start, it will disappear!
                            </b>
                          </p>
                        </span>
                      )}
                        ...
                        <div className={classes.boxdiv}>
                          <div className={classes.result}>
                            {flag !== 2 && inputText !== "" && (
                              <h5
                                className={
                                  flag ? classes.rightcolor : classes.wrongcolor
                                }
                              >
                                {flag === 1
                                  ? t("Right")
                  ...
                  <div className={classes.boxdiv}>
                    <h5 className={classes.timeout} style={{ color: "white" }}>
                      {t("TIME OUT !!!")}
                    </h5>
                  </div>
                )}

...
const BalloonSVG: React.FC<Props> = ({ width, burst }) => {
  return (
    <svg
      width={width}
      xmlnsXlink="http://www.w3.org/1999/xlink"
      viewBox="0 0 327.78 400.03"
      className={burst ? "balloon-burst" : ""}
    >
      <defs>
        <radialGradient
          id="radial-gradient"
          cx="-8178.99" cy="-7548.19" r="21.1"
        ...
        <radialGradient
          ...
          cx="-8213.4" cy="-7300.26" r="165.23"
          xlinkHref="#radial-gradient"
        />
        <radialGradient
          id="radial-gradient-3"
          cx="-8265.73" cy="9305.61" r="53.61"
      ...
      <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
          <g id="balloons">
            ...
            {/* Highlight */}
            <path
              style={{ opacity: 0.7, fill: "url(#radial-gradient-3)" }}

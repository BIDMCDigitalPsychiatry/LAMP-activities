...
class Board extends React.Component<BoardProps, BoardState> {
  ...
  resetState = () => {
    let dogTempCount = this.state.successCompletion ? this.state.dogCount + 1 : this.state.dogCount -1
    let boxCount =  this.state.successCompletion ? this.state.boxCount + 2 : this.state.boxCount -2
    if (

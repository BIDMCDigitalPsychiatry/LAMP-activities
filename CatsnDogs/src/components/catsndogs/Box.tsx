...
export class Box extends React.Component<BoxProps> {   
   // To handle box click which inturn call parent function
    ...
    render() {
      const classN = this.props.img !== null && this.props.animateStatus === true ? this.props.boxSQClass + ' slideIn' : 
        (this.props.animateStatus === false ||  this.props.img === null ?   this.props.boxSQClass :  this.props.boxSQClass + ' slideOut');
      return (

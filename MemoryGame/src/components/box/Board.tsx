      ...
      this.setState(
        {
          ...
          timeTakenTrial1 : this.state.trail ===1 ? new Date().getTime() - this.state.currentTime : this.state.timeTakenTrial1,
          timeTakenTrial2 : this.state.trail ===2 ? new Date().getTime() - this.state.currentTime : this.state.timeTakenTrial2,
          timeTakenTrial3 : this.state.trail ===3 ? new Date().getTime() - this.state.currentTime : this.state.timeTakenTrial3,
          timeTakenRecall : this.state.trail > 3 ? new Date().getTime() - this.state.currentTime : this.state.timeTakenRecall,
        },
        () => {          
      ...
      this.setState(
        {
          ...
          lastClickTime: new Date().getTime(),
          totalLearningScore:
            statusVal === true && this.state.trail <= 3
      ...
      () => {
        ...
        console.log("result", JSON.stringify({
          ...
          static_data: Object.assign(this.state.staticData ?? {}, {
            ...
            time_taken_trial1 : this.state.timeTakenTrial1,
            time_taken_trial2 : this.state.timeTakenTrial2,
            time_taken_trial3 : this.state.timeTakenTrial3,
            ...
            {!!this.state && !!this.state.error ? (
              ...
              <div>
                <div className="timer-div">
                  {!!this.state.autoCorrect && this.state.trail <= 3 && (
                    <div>

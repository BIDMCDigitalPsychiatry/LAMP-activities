...
class Board extends React.Component<BoardProps, BoardState> {
  ...
  resetState = (type?: number) => {
    ...
    if (this.state.trail === this.props.encodingTrials && !this.state.showQuestions) {
      this.setState(
        {
          loading: false,
          showQuestions: true,
      ...
      this.setState(
        {
          ...
          animate: false,
          autoCorrect: this.state.trail <= this.props.encodingTrials ? true : false,
          boxClass: ["box-square"],
          boxCount: 1,
          boxes: null,
          clickedImageIndex: -1,
          ...
          images:
            this.state.allImages.length > 0
              ...
              : selected?.images,
          lastClickTime: null,
          loading: this.state.trail > 0 && this.state.trail <= this.props.encodingTrials ? true : false,
          orderNumber: -1,
          randomPoints:
    ...
    if (this.state.completedIndex === this.props.seqLength) {
      ...
      this.setState((prevState)=>
        ({
          ...
          timeTakenForEachTrial : this.state.trail <= this.props.encodingTrials ? {...prevState.timeTakenForEachTrial,
            [this.state.trail] : new Date().getTime() - this.state.currentTime} : this.state.timeTakenForEachTrial ,          
          timeTakenRecall : this.state.trail > this.props.encodingTrials ? new Date().getTime() - this.state.currentTime : this.state.timeTakenRecall,
        }),
        () => {          
  ...
  updateWithTaps = async (index: number, type: number, statusVal: boolean) => {
    ...
    if (!!status) {
      const route = {
        ...
        item: type,
        level: this.state.trail > this.props.encodingTrials ? this.props.encodingTrials + 1 : this.state.trail,
        type: statusVal,
  ...
  render() {
    ...
    const audio = this.state.autoCorrect && this.state.playAudio === 2 ? <AudioPlayer sound={successAudo}/> : this.state.autoCorrect && this.state.playAudio === 1 ?   <AudioPlayer sound={failAudio}/> : null
            ...
            {!!this.state && !!this.state.error ? (
              ...
              <div>
                <div className="timer-div">
                  {!!this.state.autoCorrect && this.state.trail <= this.props.encodingTrials && (
                    <div>
